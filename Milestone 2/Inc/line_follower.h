...
#define LINE_FOLLOWER_BASE_SPEED_PWM 650 // Podstawowa prędkość PWM silników
#define LINE_FOLLOWER_MIN_SPEED_PWM 650 // Minimalna dopuszczalna prędkość PWM silników
...
#define SHARP_TURN_PWM 700 // Prędkość PWM silników podczas wykonywania ostrego zakrętu
...
#define LOST_LINE_REVERSE_PWM 710           // Prędkość PWM podczas cofania
